...
public class TrumpetTest {
    ...
    sent_by_me_is_false_when_sender_and_receiver_is_not_the_same() {
        // Given
        Trumpeteer sender = new TrumpeteerImpl("id1", "linkId", Location.location(22.3d, 23.2d, 10), mock(SubscriberOutput.class), mock(TrumpeteerConfig.class));
        Trumpeteer receiver = new TrumpeteerImpl("id2", "linkId", Location.location(22.3d, 23.5d, 10), mock(SubscriberOutput.class), mock(TrumpeteerConfig.class));
    ...
    sent_by_me_is_true_when_sender_and_receiver_is_same() {
        // Given
        Trumpeteer sender = new TrumpeteerImpl("id1", "linkId", Location.location(22.3d, 23.2d, 10), mock(SubscriberOutput.class), mock(TrumpeteerConfig.class));
        Trumpeteer receiver = new TrumpeteerImpl("id1", "linkId", Location.location(22.3d, 23.5d, 10), mock(SubscriberOutput.class), mock(TrumpeteerConfig.class));
