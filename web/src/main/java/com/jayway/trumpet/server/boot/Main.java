...
public class Main {
    ...
    private static void docs(){
        ...
        System.out.println("        \"subscriptions\": { \"href\" : \"http://localhost:9191/api/trumpeteers/1/subscriptions\" },");
        ...
        System.out.println("-----------------------------------------------------------------------------------------------");
        System.out.println("");
        System.out.println("curl -X POST --data \"message=This is my first trumpet&distance=200&topic=foo\" http://localhost:9191/api/trumpeteers/1/trumpet");
        ...
        System.out.println("-----------------------------------------------------------------------------------------------");
        System.out.println("");
        System.out.println("curl -X POST --data \"type=sse&registrationID=32314234234\" http://localhost:9191/api/trumpeteers/1/subscriptions");
        System.out.println("The form parameter type can be : sse | gcm");
        System.out.println("Only type 'sse' will produce a link in the result");
        System.out.println("Response: Content-type: application/json");
        System.out.println("{");
        System.out.println("    \"type\": \"sse\",");
        System.out.println("    \"_links\": {");
        System.out.println("        \"subscription\": { \"href\" : \"http://localhost:9191/api/trumpeteers/1/subscription/sse\" },");
        System.out.println("    }");
        System.out.println("}");
        System.out.println("-----------------------------------------------------------------------------------------------");
        System.out.println("SUBSCRIPTION (SSE)");
        System.out.println("-----------------------------------------------------------------------------------------------");
        System.out.println("1. Open EventSource to entry point link with rel 'subscription' returned when POSTING to ep:subscriptions  ");
        ...
        System.out.println("   \"topic\": \"bar\", ");
        System.out.println("   \"distanceFromSource\": 240,");
        System.out.println("   \"accuracy\": 10");
        System.out.println("   \"_links\": {");
        System.out.println("        \"echo\": { \"href\" : \"http://localhost:9191/api/trumpeteers/1/echo?trumpedId=xxxx&message=foo&distance=200&topic=foo\" },");
        System.out.println("    }");
        System.out.println("}");
    }
}
